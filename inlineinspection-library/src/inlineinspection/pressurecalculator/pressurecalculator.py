...
class PressureCalculator(object):
    ...
    def getParameterInfo(self):
        ...
        in_ili_maop_features = arcpy.Parameter(displayName="Input Pipeline MAOP Feature Class",
        ...
        # Parameter [27]
        in_ss_routeid_field = arcpy.Parameter(category ="Station Series Parameters",
        ...
        # Parameter [28]
        in_ss_begin_m_field = arcpy.Parameter(category ="Station Series Parameters",
        ...
        # Parameter [29]
        in_ss_end_m_field = arcpy.Parameter(category ="Station Series Parameters",
        ...
        # Parameter [30]
        in_ss_eventid_field = arcpy.Parameter(category ="Station Series Parameters",
        ...
        # Parameter [31]
        in_ps_diameter_field = arcpy.Parameter(category ="Pipe Segment Parameters",
        ...
        # Parameter [32]
        in_ps_thickness_field = arcpy.Parameter(category ="Pipe Segment Parameters",
        ...
        # Parameter [33]
        in_ps_syms_field = arcpy.Parameter(category ="Pipe Segment Parameters",
        ...
        in_maop_field = arcpy.Parameter(category ="MAOP Parameters",
        ...
        parameters = [in_pipe_parameter_type, 
                      in_ili_features,
                      in_pc_length_field,
    ...
    def execute(self, parameters, messages):
        ...
        try:
            ...
            if(arcpy.Exists(ili_inputpoint_fc)):                  
                ...
                if (ilicount > 0):  
                    if(parameters[0].value==config.ILI_PIPE_PARAMETER_TYPE[2]):
    ...
    def build_json_for_segmentor(self, ili_layer, maop_layer,parameters):
        ...
        self.structure_segment = os.path.basename(parameters[24].valueAsText)
        self.projDatabase = r"C:\G2\UnitedBrine\Anomaly Comparison\Freeport\PODS_ili.gdb"
        self.projDataSet="Transmission"
        name_1 = self.structure_segment
        path_1 = parameters[24].valueAsText
        routeIdentifierField_1 = "RouteEventID"
        fromMeasureField_1 = "BeginMeasure"
        toMeasureField_1 = "EndMeasure"
        fromMeasureField_2="Measure"
        ...
        if maop_layer:
            name_3 = maop_layer
            path_3 =  parameters[26].valueAsText
    ...
    def build_segmentor_table(self,parameters):
        ...
        pipesegment_layer=os.path.basename(parameters[24].valueAsText)
        self.input_centerline =parameters[25].valueAsText
        maop_layer = os.path.basename(parameters[26].valueAsText)
        CENTERLINE_UNIQUE_ID =parameters[27].valueAsText
        CENTERLINE_BEGIN_MEASURE =parameters[28].valueAsText
        CENTERLINE_END_MEASURE = parameters[29].valueAsText
    ...
    def run(self,parameters):
        try:
            ...
            if(parameters[0].value==config.ILI_PIPE_PARAMETER_TYPE[1]):
                ...
                maxDiameter=parameters[31].valueAsText
                measuredWallthickness=parameters[32].valueAsText                
                pipeSmys=parameters[33].valueAsText
                pipeSmysValOrField ="!"+pipeSmys+"!" 
                pipeMAOPField=parameters[34].valueAsText
