...
class InLineInspectionLog():
    ...
    def __init__(self, file=None, db=None, params=["PRINT"],
        ...
        db - The ArcGIS ".sde" file where the InLineInspection logging table is.
        ...
        try:
            import arcpy
            #arcpy.AddMessage("Start Logging from InLineInspectionLog")
        ...
        if("FILE" in self._log_params) and (self._log_location_file == None):
            import tempfile
            tf = tempfile.NamedTemporaryFile(mode='a', prefix="InLineInspectionLog_",
